<template>
    <el-scrollbar height="300px" ref="scrollbarRef">
        <el-menu mode="vertical" default-active="0">
            ...
            <el-menu-item index="0" @click="trayQuit">
                <el-icon>
                    <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-029747aa="">
                        <path fill="currentColor"
...
window.background.focusTray(() =>
{
    scrollbarRef.value?.scrollTo(0, document.querySelector('.el-menu')?.clientHeight ?? 0);
});
